...
public class itemPrice {
    public void getPrice1() {
        ...
        System.out.println("Enter First Item Dude: ");
        ...
        switch (purchase) {
            ...
            case "13" -> {
                item = 39.97;
            } //Tops Opening Day Baseball Value Pack
            case "14" -> {
                item = 138.99;
            } //Retro Typewriter Keyboard 7 Keys
            case "15" -> {
                item = 35.95;
            } //Hydro Flask
            case "16" -> {
            ...
            case "20" -> {
                item = 99;
            } //Comfort Carry Portable Locker Pack, 42L
            case "21" -> {
                item = 39.95;
            ...
            case "24" -> {
                item = 32.39;
            } //WEWLINE 17-Inch Tool Box
            case "25" -> {
                item = 13.80;
            } //BIC Xtra-Smooth Mechanical Pencils
            case "26" -> {
                item = 21.99;
            } //3 Pack (AppleMFi Certified)
            case "27" -> {
                item = 10.34;
            } //Amazon Basics Small Digital Alarm Clock
            case "28" -> {
                item = 76990;
            } //Tesla Model 3 all Decked out
            case "29" -> {
                item = 599;
